...
<div class="modal-window fade_in coupon-modal">
    <div class="modal-wrapper container"><h2>Steak House Restaurant</h2>
        <figure>63 Birch Street</figure>
        <div class="rating" data-rating="4"></div>
        <div class="modal-body row">
            <div class="gallery col-md-6 col-sm-12 col-xs-12 col-lg-6">
                <div class="image">
            ...
            <div class="modal-content col-md-6 col-sm-12 col-xs-12 col-lg-6">
