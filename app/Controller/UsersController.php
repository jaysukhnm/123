...
class UsersController extends AppController {
	...
	if ($this->request->is('ajax')):
		...
		if (!empty($tbluser_id)):
		    ...
		    $this->Tbluser->saveField('facebook_link', 'Yes');
		    ...
		    $this->Tbluser->save($tbluser_data, $validate = false);
		    $last_i_id = $this->Tbluser->id;
		    $user = $this->Tbluser->findByuserid($last_i_id);
		    $this->Session->delete('User');
	...
	$request_token = $connection->getRequestToken(FULL_BASE_URL . '/tblusers/twitter_callback');
